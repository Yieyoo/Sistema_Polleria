  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <footer className="bg-brand-900 text-gray-400 text-center py-10 mt-12">
        ...
        <p className="text-sm mt-2">💳 Aceptamos tarjetas</p>

        <div className="h-px bg-white/10 mx-8 my-6" />

        {/* WhatsApp CTA */}
        <p className="text-white font-semibold text-sm mb-1">💬 ¿Necesitas ayuda con tu pedido?</p>
        ...
        <div className="mt-8">
          <a href="/admin/login" className="text-gray-600 hover:text-gray-400 text-xs underline">
