...
export const PRODUCTS = [
  ...
  { id: 35, category_id: 12, category_name: 'Especialidades', category_emoji: '🔥',
    name: 'Palomitas de Pollo', short_name: 'Palomitas de Pollo', group: 'Clásicos', unit: '250 g aprox.',
  ...
  { id: 42, category_id: 12, category_name: 'Especialidades', category_emoji: '🔥',
    name: 'Empanadas', short_name: 'Empanadas', group: 'Clásicos', unit: 'charola (4 pza)',
  ...
  { id: 43, category_id: 12, category_name: 'Especialidades', category_emoji: '🔥',
    name: 'Hamburguesa de Pollo', short_name: 'Hamburguesa', group: 'Clásicos', unit: 'charola (4 pza)',
    ...
    available: true, sort_order: 3 },
  { id: 54, category_id: 12, category_name: 'Especialidades', category_emoji: '🔥',
    name: 'Dedos de Queso', short_name: 'Dedos de Queso', group: 'Clásicos', unit: '4 pza',
    description: 'Dedos de queso fundido empanizados y fritos.',
    price: '65.00', image_url: 'https://images.unsplash.com/photo-1619881590738-a111d176d906?w=500&q=80',
    available: true, sort_order: 4 },
  { id: 55, category_id: 12, category_name: 'Especialidades', category_emoji: '🔥',
    name: "Bite's de Pollo", short_name: "Bite's", group: 'Clásicos', unit: '250 g aprox.',
    description: 'Pequeños bocados de pollo empanizado extra crujientes.',
    price: '70.00', image_url: 'https://images.unsplash.com/photo-1619881590738-a111d176d906?w=500&q=80',
    available: true, sort_order: 5 },
  { id: 56, category_id: 12, category_name: 'Especialidades', category_emoji: '🔥',
    name: 'Dedos de Pescado 🐟', short_name: 'Dedos de Pescado 🐟', group: 'Clásicos', unit: '4 pza',
    description: 'Dedos de pescado empanizados, crujientes por fuera y jugosos por dentro.',
    price: '70.00', image_url: 'https://images.unsplash.com/photo-1619881590738-a111d176d906?w=500&q=80',
  ...
  { id: 36, category_id: 12, category_name: 'Especialidades', category_emoji: '🔥',
    name: 'Tenders Natural', short_name: 'Natural', group: 'Tenders', unit: '500 g aprox.',
    description: 'Tiras de pechuga empanizadas, crujientes y jugosas.',
  ...
  { id: 40, category_id: 12, category_name: 'Especialidades', category_emoji: '🔥',
    name: 'Boneless Pimienta Limón 🍋', short_name: 'Pimienta Limón 🍋', group: 'Boneless', unit: '250 g aprox.',
    description: 'Pollo sin hueso empanizado, sabor original crujiente.',
    price: '80.00', image_url: 'https://images.unsplash.com/photo-1562967914-608f82629710?w=500&q=80',
    available: true, sort_order: 7 },
