...
const PRESENTACIONES_PECHUGA = ['Entera', 'Bistec', 'Fajitas', 'Alambre', 'Molida', 'Para Cocer'];

function formatPechugas(n) {
  const whole = Math.floor(n);
  const half  = Math.round(n * 2) % 2 !== 0;
  if (whole === 0) return '½';
